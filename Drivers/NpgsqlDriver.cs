...
public sealed class NpgsqlDriver
    : EnumDbDriver,
        IOne,
        IMany,
        IExec,
        ...
        ICopyFrom
{
    ...
    public NpgsqlDriver(Options options, Catalog catalog, IList<Query> queries)
    ...
    protected override Dictionary<string, ColumnMapping> ColumnMappings { get; } =
        new()
        {
            ...
            ["int"] = new(
                ...
                readerArrayFn: (ordinal, _) =>
                    $"{Variable.Reader.AsVarName()}.GetFieldValue<int[]>({ordinal})",
            ...
            ["long"] = new(
                ...
                readerArrayFn: (ordinal, _) =>
                    $"{Variable.Reader.AsVarName()}.GetFieldValue<long[]>({ordinal})",
                convertFunc: x => $"Convert.ToInt64({x})"
            ),
            ["float"] = new(
                new() { { "float4", new() }, { "real", new() } },
                readerFn: (ordinal, _) => $"{Variable.Reader.AsVarName()}.GetFloat({ordinal})",
                readerArrayFn: (ordinal, _) =>
                    $"{Variable.Reader.AsVarName()}.GetFieldValue<float[]>({ordinal})"
            ),
            ["decimal"] = new(
                new()
                {
            ...
            ["double"] = new(
                ...
                readerArrayFn: (ordinal, _) =>
                    $"{Variable.Reader.AsVarName()}.GetFieldValue<double[]>({ordinal})"
            ),
            ...
            ["string"] = new(
                ...
                readerArrayFn: (ordinal, _) =>
                    $"{Variable.Reader.AsVarName()}.GetFieldValue<string[]>({ordinal})"
            ),
            ...
            ["XmlDocument"] = new(
                new() { { "xml", new(NpgsqlTypeOverride: "NpgsqlDbType.Xml") } },
            ...
            ["NpgsqlPoint"] = new(
                new() { { "point", new() } },
                readerFn: (ordinal, _) =>
                    $"{Variable.Reader.AsVarName()}.GetFieldValue<NpgsqlPoint>({ordinal})",
                readerArrayFn: (ordinal, _) =>
                    $"{Variable.Reader.AsVarName()}.GetFieldValue<NpgsqlPoint[]>({ordinal})",
                usingDirectives: ["NpgsqlTypes"],
            ...
            ["NpgsqlLine"] = new(
                new() { { "line", new() } },
                readerFn: (ordinal, _) =>
                    $"{Variable.Reader.AsVarName()}.GetFieldValue<NpgsqlLine>({ordinal})",
                readerArrayFn: (ordinal, _) =>
                    $"{Variable.Reader.AsVarName()}.GetFieldValue<NpgsqlLine[]>({ordinal})",
                usingDirectives: ["NpgsqlTypes"],
            ...
            ["NpgsqlLSeg"] = new(
                new() { { "lseg", new() } },
                readerFn: (ordinal, _) =>
                    $"{Variable.Reader.AsVarName()}.GetFieldValue<NpgsqlLSeg>({ordinal})",
                readerArrayFn: (ordinal, _) =>
                    $"{Variable.Reader.AsVarName()}.GetFieldValue<NpgsqlLSeg[]>({ordinal})",
                usingDirectives: ["NpgsqlTypes"],
            ...
            ["NpgsqlBox"] = new(
                new() { { "box", new() } },
                readerFn: (ordinal, _) =>
                    $"{Variable.Reader.AsVarName()}.GetFieldValue<NpgsqlBox>({ordinal})",
                readerArrayFn: (ordinal, _) =>
                    $"{Variable.Reader.AsVarName()}.GetFieldValue<NpgsqlBox[]>({ordinal})",
                usingDirectives: ["NpgsqlTypes"],
            ...
            ["NpgsqlPath"] = new(
                new() { { "path", new() } },
                readerFn: (ordinal, _) =>
                    $"{Variable.Reader.AsVarName()}.GetFieldValue<NpgsqlPath>({ordinal})",
                readerArrayFn: (ordinal, _) =>
                    $"{Variable.Reader.AsVarName()}.GetFieldValue<NpgsqlPath[]>({ordinal})",
                usingDirectives: ["NpgsqlTypes"],
            ...
            ["NpgsqlPolygon"] = new(
                new() { { "polygon", new() } },
                readerFn: (ordinal, _) =>
                    $"{Variable.Reader.AsVarName()}.GetFieldValue<NpgsqlPolygon>({ordinal})",
                readerArrayFn: (ordinal, _) =>
                    $"{Variable.Reader.AsVarName()}.GetFieldValue<NpgsqlPolygon[]>({ordinal})",
                usingDirectives: ["NpgsqlTypes"],
            ...
            ["NpgsqlCircle"] = new(
                new() { { "circle", new() } },
                readerFn: (ordinal, _) =>
                    $"{Variable.Reader.AsVarName()}.GetFieldValue<NpgsqlCircle>({ordinal})",
                readerArrayFn: (ordinal, _) =>
                    $"{Variable.Reader.AsVarName()}.GetFieldValue<NpgsqlCircle[]>({ordinal})",
                usingDirectives: ["NpgsqlTypes"],
            ...
            ["NpgsqlCidr"] = new(
                new() { { "cidr", new() } },
                readerFn: (ordinal, _) =>
                    $"{Variable.Reader.AsVarName()}.GetFieldValue<NpgsqlCidr>({ordinal})",
                readerArrayFn: (ordinal, _) =>
                    $"{Variable.Reader.AsVarName()}.GetFieldValue<NpgsqlCidr[]>({ordinal})",
                usingDirectives: ["NpgsqlTypes"],
            ...
            ["IPAddress"] = new(
                new() { { "inet", new() } },
                readerFn: (ordinal, _) =>
                    $"{Variable.Reader.AsVarName()}.GetFieldValue<IPAddress>({ordinal})",
                readerArrayFn: (ordinal, _) =>
                    $"{Variable.Reader.AsVarName()}.GetFieldValue<IPAddress[]>({ordinal})",
            ...
            ["PhysicalAddress"] = new(
                new() { { "macaddr", new() } },
                readerFn: (ordinal, _) =>
                    $"{Variable.Reader.AsVarName()}.GetFieldValue<PhysicalAddress>({ordinal})",
                readerArrayFn: (ordinal, _) =>
                    $"{Variable.Reader.AsVarName()}.GetFieldValue<PhysicalAddress[]>({ordinal})",
            ...
            ["NpgsqlTsQuery"] = new(
                new() { { "tsquery", new() } },
                readerFn: (ordinal, _) =>
                    $"{Variable.Reader.AsVarName()}.GetFieldValue<NpgsqlTsQuery>({ordinal})",
                readerArrayFn: (ordinal, _) =>
                    $"{Variable.Reader.AsVarName()}.GetFieldValue<NpgsqlTsQuery[]>({ordinal})",
                usingDirectives: ["NpgsqlTypes"],
            ...
            ["NpgsqlTsVector"] = new(
                new() { { "tsvector", new() } },
                readerFn: (ordinal, _) =>
                    $"{Variable.Reader.AsVarName()}.GetFieldValue<NpgsqlTsVector>({ordinal})",
                readerArrayFn: (ordinal, _) =>
                    $"{Variable.Reader.AsVarName()}.GetFieldValue<NpgsqlTsVector[]>({ordinal})",
                usingDirectives: ["NpgsqlTypes"],
            ...
            ["Guid"] = new(
                new() { { "uuid", new() } },
                readerFn: (ordinal, _) =>
                    $"{Variable.Reader.AsVarName()}.GetFieldValue<Guid>({ordinal})",
                readerArrayFn: (ordinal, _) =>
                    $"{Variable.Reader.AsVarName()}.GetFieldValue<Guid[]>({ordinal})",
            ...
            ["byte[]"] = new(
                ...
                readerFn: (ordinal, _) =>
                    $"{Variable.Reader.AsVarName()}.GetFieldValue<byte[]>({ordinal})",
                readerArrayFn: (ordinal, _) =>
                    $"{Variable.Reader.AsVarName()}.GetFieldValue<byte[][]>({ordinal})"
            ),
            ["object"] = new(
    ...
    private static readonly SqlMapperImplFunc XmlDocumentTypeHandler = isDotnetCore =>
        $$"""
            private class XmlDocumentTypeHandler : SqlMapper.TypeHandler<XmlDocument>
            {
                ...
                public override void SetValue(IDbDataParameter parameter, XmlDocument{{(
                isDotnetCore ? "?" : string.Empty
            )}} value)
                {
                    if (value is null)
                        return;
    ...
    public MemberDeclarationSyntax OneDeclare(
    ...
    {
        return new OneDeclareGen(this).Generate(
            queryTextConstant,
            argInterface,
            returnInterface,
            query
    ...
    public MemberDeclarationSyntax ExecDeclare(
        string queryTextConstant,
        string argInterface,
        Query query
    )
    ...
    public MemberDeclarationSyntax ManyDeclare(
        string queryTextConstant,
        string argInterface,
        string returnInterface,
        Query query
    ...
    {
        return new ManyDeclareGen(this).Generate(
            queryTextConstant,
            argInterface,
            returnInterface,
            query
    ...
    public MemberDeclarationSyntax ExecRowsDeclare(
        string queryTextConstant,
        string argInterface,
        Query query
    )
    ...
    public MemberDeclarationSyntax ExecLastIdDeclare(
        string queryTextConstant,
        string argInterface,
        Query query
    )
    ...
    public MemberDeclarationSyntax CopyFromDeclare(
        string queryTextConstant,
        string argInterface,
        Query query
    )
    ...
    {
        return base.GetPackageReferences()
            .Merge(
                new Dictionary<string, string>
                {
                    {
                        "Npgsql",
                        Options.OverrideDriverVersion != string.Empty
                            ? Options.OverrideDriverVersion
                            : DefaultNpgsqlVersion
                    },
                }
            );
    }
    ...
    public override ISet<string> GetUsingDirectivesForQueries()
    {
        return base.GetUsingDirectivesForQueries()
            .AddRangeExcludeNulls(["Npgsql", "Npgsql.NameTranslation", "System.Data"]);
    }

    public override ISet<string> GetUsingDirectivesForModels()
    {
        return base.GetUsingDirectivesForModels()
            .AddRangeExcludeNulls(["System", "System.Collections.Generic"]);
    }
    ...
    public override ISet<string> GetUsingDirectivesForUtils()
    {
        ...
        return usingDirectives.AddRangeExcludeNulls(["NpgsqlTypes"]);
    }
    ...
    public override ClassDeclarationSyntax GetClassDeclaration(
        string className,
    ...
    {
        var enumMappings = new List<string>();
        if (this is EnumDbDriver enumDbDriver)
        {
            foreach (var enumGroup in enums)
            {
                foreach (var enumType in enumGroup.Value)
                {
    ...
    )
    {
        return
        [
            .. base.GetEnumExtensionsMembers(name, possibleValues)
    ...
    public override ConnectionGenCommands EstablishConnection(Query query)
    {
        ...
        var useOpenConnection =
            query.Cmd == ":copyfrom" || (Options.UseDapper && !embedTableExists);
    ...
    {
        return $"var {Variable.Command.AsVarName()} = {Variable.DataSource.AsPropertyName()}.CreateCommand({sqlTextConstant})";
    }

    public override string GetNoTransactionConnectionCode(Query query)
    {
        // For DataSource, we don't need to establish a connection in the using block
        // The DataSource manages connections internally
        return string.Empty;
    }

    public override string GetNoTransactionCommandCode(string sqlVar, Query query)
    {
        // For DataSource, we create the command directly from the DataSource
    ...
    public override string GetWithTransactionCommandCode(string sqlVar, Query query)
    {
        // For transactions, we still use the connection from the transaction
    ...
    public string GetCopyFromImpl(Query query, string queryTextConstant)
    {
        ...
        var beginBinaryImport =
            $"{Variable.Connection.AsVarName()}.BeginBinaryImportAsync({queryTextConstant}";
        var connectionVar = Variable.Connection.AsVarName();
    ...
    public override WriterFn? GetWriterFn(Column column, Query query)
    {
        ...
        if (GetEnumType(column) is not null)
        {
            return (el, dbType, notNull, isDapper, isLegacy) =>
            {
                //var nullValue = isDapper ? "null" : "(object)DBNull.Value";
                if (isDapper)
                    return notNull ? $"{el}.Stringify()" : $"{el}.HasValue ? {el}.Value.Stringify() : null";
                else
                    return notNull ? $"{el}" : $"{el} ?? (object)DBNull.Value";
            };
        }
        ...
        return uniqueParams
            .Select(p =>
            {
                ...
                var addParamToCommand =
                    $"""{commandVar}.Parameters.AddWithValue("@{p.Column.Name}", {optionalNpgsqlTypeOverride}{paramToWrite});""";
